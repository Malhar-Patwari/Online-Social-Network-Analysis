    ...
    for i in users:
        ...
        for j in users:
            ...
            if (icount<jcount):             
                ...
                c=Counter()
                c.update(i['friends'][0])
                c.update(j['friends'][0])  
                common_friends = [k for k in i['friends'][0] if c[k]==2]                           
        ...
        if i['screen_name']=="HillaryClinton":          
            for j in users:             
                if j['screen_name']=="realDonaldTrump":                 
                    ...
                    c.update(i['friends'][0])
                    c.update(j['friends'][0])
                    common_friend=[k for k in i['friends'][0] if c[k]==2]
                    break
    #print(common_friend)    
